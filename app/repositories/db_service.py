...
def update_user_profile(uid: str, name: str = None, display_name: str = None, grade_level: int = None, help_tone_preference: str = None):
    """Update user profile fields using the configured database provider."""
    try:
        db_provider.update_user_profile(uid, name, display_name, grade_level, help_tone_preference)
